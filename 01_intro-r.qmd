...
Lots of active package development!

::: {r-stack}
![howarddo2208.github.io](https://howarddo2208.github.io/assets/02-repository-comparison.png#center){.fragment width="800"}
:::
...
![Artwork by [@allison_horst](https://twitter.com/allison_horst)](https://cdn.myportfolio.com/45214904-6a61-4e23-98d6-b140f8654a40/c2ef45f1-4a68-4c7a-a43f-bdcf0f90e104_rw_3840.png?h=783eba914284e5adfb9feadcf4ba5f1e){fig-alt="A schematic representing the multi-language input (e.g. Python, R, Observable, Julia) and multi-format output (e.g. PDF, html, Word documents, and more) versatility of Quarto."}


## Naming conventions

Characters, numbers, underscore (`_`), and dot (`.`) allowed

- **BUT** names cannot start with a number

. . .

Use of  `_` for naming is preferred

. . .

Some names not allowed if they override existing objects (e.g. `if`, `NA`)

. . .

Others allowed, but not recommended (e.g. `TRUE`, `df`, `mean`)
